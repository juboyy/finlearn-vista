                ...
                <div className="grid grid-cols-12 gap-8">
                  ...
                  <div className="col-span-12 lg:col-span-8 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="col-span-2">
                        <label className="block text-sm font-medium text-slate-700 mb-2">Canais de Distribuição</label>
                        <div className="p-4 border border-slate-300 rounded-lg bg-white">
                          <p className="text-xs text-slate-500 mb-3">Escolha por quais canais deseja enviar as notificações</p>
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <label className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:border-[hsl(var(--pastel-purple))] hover:bg-slate-50 cursor-pointer transition">
                              <input type="checkbox" defaultChecked className="w-4 h-4 rounded text-purple-600 focus:ring-purple-500 border-gray-300" />
                              <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#B8D4E8' }}>
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:border-[hsl(var(--pastel-purple))] hover:bg-slate-50 cursor-pointer transition">
                              <input type="checkbox" className="w-4 h-4 rounded text-purple-600 focus:ring-purple-500 border-gray-300" />
                              <div className="flex items-center gap-2">
                            ...
                            <label className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 hover:border-[hsl(var(--pastel-purple))] hover:bg-slate-50 cursor-pointer transition">
                              <input type="checkbox" className="w-4 h-4 rounded text-purple-600 focus:ring-purple-500 border-gray-300" />
                              <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#E8D4C5' }}>
                                  <span className="text-slate-700 text-sm">📱</span>
                                </div>
