        ...
        <div className="flex-1 relative bg-muted/30">
          ...
          <div className="w-full max-w-[1600px] mx-auto px-8 py-8 grid grid-cols-12 gap-6">
            ...
            <article id="article-content" className="col-span-6 bg-card rounded-xl border border-border p-8">
              ...
              {/* Outros Relatórios Recomendados - Card Separado */}
              {currentPage === 7 && (
                <div className="mt-8 bg-card rounded-xl border border-border p-8 animate-fade-in">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#D4C5E8] to-[#B8D4E8] rounded-lg flex items-center justify-center">
                      <BookOpen className="w-6 h-6 text-[#475569]" />
                    </div>
                    <h2 className="text-2xl font-bold text-foreground">Outros Relatórios de Análise Recomendados</h2>
                  </div>
