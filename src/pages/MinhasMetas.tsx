        ...
        <div className="p-8 max-w-7xl mx-auto">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-pastel-yellow rounded-lg flex items-center justify-center">
                    <i className="fas fa-clipboard-list text-slate-700"></i>
                  </div>
                  <div>
          ...
          <section className="mb-8">
            <div className="bg-white rounded-2xl border-2 border-slate-200 p-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="p-5 rounded-xl" style={{backgroundColor: 'hsl(206 35% 65% / 0.5)'}}>
                ...
                <div className="p-5 rounded-xl" style={{backgroundColor: 'hsl(152 32% 65% / 0.5)'}}>
                  <div className="flex items-center justify-center mb-3">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-sm">
                ...
                <div className="p-5 rounded-xl" style={{backgroundColor: 'hsl(270 32% 67% / 0.5)'}}>
                  <div className="flex items-center justify-center mb-3">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-sm">
                ...
                <div className="p-5 rounded-xl" style={{backgroundColor: 'hsl(44 35% 67% / 0.5)'}}>
                  <div className="flex items-center justify-center mb-3">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-sm">
