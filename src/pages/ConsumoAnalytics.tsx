        ...
        <div className="p-8">
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              <div className="p-4 rounded-lg border border-slate-200" style={{ backgroundColor: 'hsl(var(--pastel-blue) / 0.0325)' }}>
              ...
              <div className="p-4 rounded-lg border border-slate-200" style={{ backgroundColor: 'hsl(var(--pastel-purple) / 0.0325)' }}>
                <div className="flex items-center justify-between mb-3">
              ...
              <div className="p-4 rounded-lg border border-slate-200" style={{ backgroundColor: 'hsl(var(--pastel-green) / 0.0325)' }}>
                <div className="flex items-center justify-between mb-3">
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            <section className="col-span-2 bg-white rounded-xl p-6 border border-slate-200">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--pastel-blue) / 0.052)' }}>
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--pastel-purple) / 0.052)' }}>
                  <div className="flex items-center gap-2 mb-2">
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--pastel-pink) / 0.052)' }}>
                  <div className="flex items-center gap-2 mb-2">
            ...
            <section className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--pastel-green) / 0.13)' }}>
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--pastel-yellow) / 0.13)' }}>
                  <div className="flex items-center gap-3 mb-2">
                ...
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'hsl(var(--pastel-peach) / 0.13)' }}>
                  <div className="flex items-center gap-3 mb-2">
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              ...
              <div className="p-3 rounded-lg border border-slate-200 bg-slate-50">
                ...
                <div className="p-3 rounded-lg border border-slate-200" style={{ backgroundColor: 'hsl(var(--pastel-blue) / 0.052)' }}>
                  <div className="flex items-center gap-2 mb-1">
                ...
                <tbody>
                  <tr className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-2 px-2 py-1 text-pastel-gray-dark text-xs rounded-full" style={{ backgroundColor: 'hsl(var(--pastel-pink) / 0.1625)' }}>
                  ...
                  <tr className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-2 px-2 py-1 text-pastel-gray-dark text-xs rounded-full" style={{ backgroundColor: 'hsl(var(--pastel-purple) / 0.1625)' }}>
                  ...
                  <tr className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-2 px-2 py-1 text-pastel-gray-dark text-xs rounded-full" style={{ backgroundColor: 'hsl(var(--pastel-blue) / 0.1625)' }}>
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-4 p-4 rounded-lg border border-slate-200">
                <div className="w-12 h-12 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'hsl(var(--pastel-blue) / 0.13)' }}>
                ...
                <span className="px-2 py-1 text-pastel-gray-dark text-xs rounded-full" style={{ backgroundColor: 'hsl(var(--pastel-green) / 0.1625)' }}>Principal</span>
                <div className="flex gap-2">
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg border border-slate-200">
                <div className="w-12 h-12 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'hsl(var(--pastel-purple) / 0.13)' }}>
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border-2 border-dashed border-slate-200" style={{ backgroundColor: 'hsl(var(--pastel-green) / 0.0325)' }}>
                <div className="flex items-center gap-3 mb-2">
              ...
              <div className="p-4 rounded-lg border-2 border-dashed border-slate-200" style={{ backgroundColor: 'hsl(var(--pastel-blue) / 0.0325)' }}>
                <div className="flex items-center gap-3 mb-2">
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-slate-100">
                    ...
                    <td className="py-4 px-4">
                      <span className="px-2 py-1 text-pastel-gray-dark text-xs rounded-full" style={{ backgroundColor: 'hsl(var(--pastel-green) / 0.1625)' }}>Pago</span>
                    </td>
                    <td className="py-4 px-4">
