        ...
        <div className="p-8">
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              <div className="p-4 rounded-lg border border-slate-200 bg-pastel-blue bg-opacity-5">
              ...
              <div className="p-4 rounded-lg border border-slate-200 bg-pastel-purple bg-opacity-5">
                <div className="flex items-center justify-between mb-3">
              ...
              <div className="p-4 rounded-lg border border-slate-200 bg-pastel-green bg-opacity-5">
                <div className="flex items-center justify-between mb-3">
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            <section className="col-span-2 bg-white rounded-xl p-6 border border-slate-200">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="p-4 rounded-lg bg-pastel-blue bg-opacity-8">
                ...
                <div className="p-4 rounded-lg bg-pastel-purple bg-opacity-8">
                  <div className="flex items-center gap-2 mb-2">
                ...
                <div className="p-4 rounded-lg bg-pastel-pink bg-opacity-8">
                  <div className="flex items-center gap-2 mb-2">
            ...
            <section className="bg-white rounded-xl p-6 border border-slate-200">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-pastel-green bg-opacity-20">
                ...
                <div className="p-4 rounded-lg bg-pastel-yellow bg-opacity-20">
                  <div className="flex items-center gap-3 mb-2">
                ...
                <div className="p-4 rounded-lg bg-pastel-peach bg-opacity-20">
                  <div className="flex items-center gap-3 mb-2">
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
              ...
              <div className="p-3 rounded-lg border border-slate-200 bg-pastel-blue bg-opacity-8">
                <div className="flex items-center gap-2 mb-1">
                ...
                <tbody>
                  <tr className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-2 px-2 py-1 bg-pastel-pink bg-opacity-25 text-pastel-gray-dark text-xs rounded-full">
                  ...
                  <tr className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-2 px-2 py-1 bg-pastel-purple bg-opacity-25 text-pastel-gray-dark text-xs rounded-full">
                  ...
                  <tr className="border-b border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="py-4 px-4">
                      <span className="inline-flex items-center gap-2 px-2 py-1 bg-pastel-blue bg-opacity-25 text-pastel-gray-dark text-xs rounded-full">
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-4 p-4 rounded-lg border border-slate-200">
                <div className="w-12 h-12 bg-pastel-blue bg-opacity-20 rounded-lg flex items-center justify-center">
                ...
                <span className="px-2 py-1 bg-pastel-green bg-opacity-25 text-pastel-gray-dark text-xs rounded-full">Principal</span>
                <div className="flex gap-2">
              ...
              <div className="flex items-center gap-4 p-4 rounded-lg border border-slate-200">
                <div className="w-12 h-12 bg-pastel-purple bg-opacity-20 rounded-lg flex items-center justify-center">
          ...
          <section className="bg-white rounded-xl p-6 border border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-lg border-2 border-dashed border-slate-200 bg-pastel-green bg-opacity-5">
                <div className="flex items-center gap-3 mb-2">
              ...
              <div className="p-4 rounded-lg border-2 border-dashed border-slate-200 bg-pastel-blue bg-opacity-5">
                <div className="flex items-center gap-3 mb-2">
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-slate-100">
                    ...
                    <td className="py-4 px-4">
                      <span className="px-2 py-1 bg-pastel-green bg-opacity-25 text-pastel-gray-dark text-xs rounded-full">Pago</span>
                    </td>
                    <td className="py-4 px-4">
