...
import { ArrowLeft, Download, Plus, Share2, MapPin, Users, Ticket as TicketIcon, QrCode, Headphones, ArrowRight, RefreshCw, Award, History } from "lucide-react";
          ...
          {activeTab === "proximos" && (
            <section className="space-y-6 mb-12">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-72 bg-pastel-purple/20 relative flex-shrink-0 border-r border-slate-100">
                  ...
                  <div className="absolute inset-0 opacity-20 pointer-events-none">
                    <img src={ticketBackgroundPattern} className="w-full h-full object-cover" alt="background pattern" />
                  </div>
                </div>
                ...
                <div className="hidden xl:flex xl:w-64 bg-slate-50 p-6 items-center justify-center border-l border-slate-100">
                  <div className="w-full h-48 relative">
                    <img className="w-full h-full object-contain" src={ticketIllustration} alt="illustration of a simple ticket icon with a qr code, pastel purple tones, outlined style, 2d flat design, thick strokes, white background" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition flex flex-col md:flex-row">
                ...
                <div className="hidden xl:flex xl:w-64 bg-slate-50 p-6 items-center justify-center border-l border-slate-100">
                  <div className="w-full h-48 relative">
                    <img className="w-full h-full object-contain" src={ticketIllustration} alt="illustration of a workshop badge icon, pastel blue tones, outlined style, 2d flat design, thick strokes, white background" />
                  </div>
                </div>
              </div>
            </section>
          ...
          {activeTab === "proximos" && (
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-pastel-green/30 rounded-xl p-6 border border-pastel-green relative overflow-hidden group">
                ...
                <div className="absolute -right-4 -bottom-4 opacity-10 rotate-12 transform group-hover:scale-110 transition duration-500">
                  <TicketIcon className="w-36 h-36" />
                </div>
              </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded bg-pastel-pink flex-shrink-0 overflow-hidden">
                            <img src={eventThumbnail} className="w-full h-full object-cover grayscale opacity-80" alt="event thumb" />
                          </div>
                          <div>
