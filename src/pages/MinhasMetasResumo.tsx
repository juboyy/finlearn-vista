...
export default function MinhasMetasResumo() {
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            ...
            <section className="bg-white rounded-2xl border-2 border-slate-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <button onClick={() => navigate('/minhas-metas')} className="w-full px-4 py-2 text-pastel-blue border border-pastel-blue rounded-lg text-sm font-medium hover:bg-pastel-blue hover:bg-opacity-10 transition">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-500 mt-1">Tipos de Conteúdo</p>
                </div>
                ...
                <div className="text-center">
                  <div className="flex items-center gap-2 justify-center">
                    ...
                    <p className="text-sm font-semibold text-slate-800">Tudo Pronto</p>
                  </div>
                  <p className="text-xs text-slate-500 mt-1">Configuração completa</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <button onClick={() => navigate('/minhas-metas/notificacoes')} className="px-5 py-3 text-slate-600 border border-slate-200 rounded-xl font-medium hover:bg-slate-50 transition">
                  <ArrowLeft className="inline w-4 h-4 mr-2" />
                  Voltar
                </button>
