...
export default function LerDepois() {
  ...
  const getPriorityBadge = (priority: string) => {
    switch (priority) {
      case 'urgent':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-pastel-rose/20 text-pastel-gray-dark rounded-full text-xs font-medium border border-pastel-rose/30">
      ...
      case 'high':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-pastel-peach/20 text-pastel-gray-dark rounded-full text-xs font-medium border border-pastel-peach/30">
            <Circle className="fill-current" size={6} />
            Alta
          </span>
        );
      case 'medium':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-pastel-yellow/20 text-pastel-gray-dark rounded-full text-xs font-medium border border-pastel-yellow/30">
            <Circle className="fill-current" size={6} />
            Média
          </span>
        );
      case 'low':
        return (
          <span className="inline-flex items-center gap-2 px-3 py-1 bg-pastel-blue/20 text-pastel-gray-dark rounded-full text-xs font-medium border border-pastel-blue/30">
            <Circle className="fill-current" size={6} />
            Baixa
          </span>
        );
          ...
          <div className="flex gap-6">
            ...
            <aside className="w-80 space-y-6 flex-shrink-0">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-pastel-yellow/20 rounded-lg flex items-center justify-center border border-pastel-yellow/30">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-pastel-green/20 rounded-lg flex items-center justify-center border border-pastel-green/30">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-pastel-rose/20 rounded-lg flex items-center justify-center border border-pastel-rose/30">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-pastel-purple/20 rounded-lg flex items-center justify-center border border-pastel-purple/30">
              ...
              <section className="bg-card rounded-xl p-6 border border-border">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-muted cursor-pointer transition">
                    <div className="w-8 h-8 bg-pastel-blue/20 rounded-lg flex items-center justify-center border border-pastel-blue/30">
                  ...
                  <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-muted cursor-pointer transition">
                    <div className="w-8 h-8 bg-pastel-peach/20 rounded-lg flex items-center justify-center border border-pastel-peach/30">
                  ...
                  <div className="flex items-center gap-2 p-2 rounded-lg hover:bg-muted cursor-pointer transition">
                    <div className="w-8 h-8 bg-pastel-pink/20 rounded-lg flex items-center justify-center border border-pastel-pink/30">
              ...
              <section className="bg-card rounded-xl p-6 border border-border">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between p-2 rounded-lg hover:bg-muted cursor-pointer transition">
                    ...
                    <span className="text-xs bg-pastel-rose/20 text-pastel-gray-dark px-2 py-0.5 rounded-full border border-pastel-rose/30">36</span>
                  </div>
                </div>
              </section>
            </aside>
                  ...
                  >
                    <div className="grid grid-cols-12 gap-4 px-6 py-4 items-center">
                      <div className="col-span-5 flex items-center gap-4">
                        <div className={`w-10 h-10 ${getTypeColor(item.type)} rounded-lg flex items-center justify-center flex-shrink-0 border ${getTypeColor(item.type).replace('/20', '/30')}`}>
                      ...
                      <div className="col-span-2">
                        {item.status === 'pending' ? (
                          ...
                          <span className="inline-flex items-center gap-2 px-3 py-1 bg-pastel-green/20 text-pastel-gray-dark rounded-full text-xs font-medium border border-pastel-green/30">
                            <Check size={12} />
                            Concluído
                          </span>
                        )}
