...
import { ArrowLeft, Bell, Plus, Send, Edit, Share2, Download, CheckCircle, User, Bot, FileText, Bookmark } from "lucide-react";
...
export default function EditarInfografico() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      // Charts will be rendered by Plotly automatically
    }, 100);
  ...
  const handleSendRefinement = () => {
    if (refinementInput.trim()) {
      console.log("Refining:", refinementInput);
      setRefinementInput("");
    }
  };
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen">
        ...
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-6 shrink-0 z-30 shadow-sm">
          <div className="flex items-center gap-4">
            <Link to="/infografico-revisao" className="text-muted-foreground hover:text-foreground transition-colors">
          ...
          <div className="flex items-center gap-3">
            <button className="px-4 py-2 text-sm font-medium rounded-lg transition-colors" style={{
              ...
              <Plus className="w-4 h-4 inline mr-2" />Novo Projeto
            </button>
            ...
            <section className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-card rounded-2xl p-5 shadow-sm border border-border">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0" style={{
                    ...
                    <i className="fa-solid fa-credit-card text-xl" style={{ color: 'hsl(var(--pastel-gray-dark))' }}></i>
                  </div>
                  <div>
                    ...
                    <div className="flex gap-2 mt-3">
                      <span className="px-2 py-1 rounded-md bg-muted text-xs font-medium text-muted-foreground">Fintech</span>
                      <span className="px-2 py-1 rounded-md bg-muted text-xs font-medium text-muted-foreground">Brasil</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-2xl p-5 shadow-sm border border-border relative overflow-hidden">
                ...
                <div className="relative pl-2">
                  {/* Step 1: User Prompt */}
                  <div className="step-line relative flex gap-4 mb-6">
                  ...
                  <div className="step-line relative flex gap-4 mb-6">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 z-10 border-2 border-card" style={{
                      ...
                      <Bot className="w-4 h-4" style={{ color: 'hsl(var(--pastel-gray-dark))' }} />
                    </div>
                    <div className="flex-1">
                      <p className="text-xs text-muted-foreground mb-1">Agente • 10:42 AM</p>
                      <div className="p-3 rounded-lg rounded-tl-none text-sm text-foreground border" style={{
                  ...
                  <div className="step-line relative flex gap-4 mb-6">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 z-10 border-2 border-card" style={{
                      ...
                      <CheckCircle className="w-4 h-4" style={{ color: 'hsl(var(--pastel-gray-dark))' }} />
                    </div>
                    <div className="flex-1">
                  ...
                  <div className="step-line relative flex gap-4">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 z-10 border-2 border-card" style={{
                      backgroundColor: 'hsl(var(--pastel-purple))'
                    }}>
                      <Bot className="w-4 h-4" style={{ color: 'hsl(var(--pastel-gray-dark))' }} />
                    ...
                    <div className="flex-1">
                      ...
                      <div className="p-4 rounded-lg rounded-tl-none border" style={{
                        ...
                        <p className="text-sm text-foreground mb-3 font-medium">Como você gostaria de prosseguir com o relatório?</p>
                ...
                <div className="mt-8 pt-4 border-t border-border">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full pl-4 pr-10 py-2.5 bg-muted border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    />
                    <button 
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="border rounded-xl p-5" style={{
                          ...
                          <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="px-3 py-1 rounded-full text-xs font-bold bg-muted text-muted-foreground inline-flex items-center gap-1 whitespace-nowrap">
