  ...
  return (
    <div>
          ...
          <section className="mb-8">
            <div className="bg-pastel-purple/20 rounded-xl border border-slate-200 p-8">
              <div className="grid grid-cols-2 gap-8 items-center">
                ...
                <div className="h-64 bg-white rounded-xl overflow-hidden">
                  <img 
                    src="https://storage.googleapis.com/uxpilot-auth.appspot.com/7fcb40b8c2-0d96ecc5a72548820724.png" 
                    alt="illustration of financial market analysis dashboard with charts graphs and data visualization, modern office desk with laptop, soft pastel purple and blue tones, clean outlined illustration style with borders, minimalist design" 
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 bg-pastel-green/20 rounded-lg flex items-center justify-center">
                    <i className="fas fa-arrow-trend-up text-slate-700 text-xl"></i>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 bg-pastel-blue/20 rounded-lg flex items-center justify-center">
                    <i className="fas fa-percentage text-slate-700 text-xl"></i>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 bg-pastel-yellow/20 rounded-lg flex items-center justify-center">
                    <i className="fas fa-dollar-sign text-slate-700 text-xl"></i>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 bg-pastel-pink/20 rounded-lg flex items-center justify-center">
                    <i className="fas fa-chart-pie text-slate-700 text-xl"></i>
                  </div>
          ...
          <section className="mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2 text-sm bg-pastel-blue/20 text-slate-700 rounded-lg font-medium">Renda Fixa</button>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-pastel-blue/20 overflow-hidden">
                  <img 
                    src="https://storage.googleapis.com/uxpilot-auth.appspot.com/27d7c99831-964c4d3004b99cb9421c.png" 
                    alt="illustration of fixed income bonds and treasury securities with growth charts, professional financial documents, soft pastel blue tones, clean outlined illustration style with borders" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-1 bg-pastel-blue/20 text-slate-700 text-xs rounded-full">Renda Fixa</span>
                      <span className="px-2 py-1 bg-green-100 text-green-700 text-xs rounded-full">Alta Confiança</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <button title="Favoritar" className="p-2 text-slate-400 hover:text-yellow-500 transition">
                        <Star size={16} />
                      </button>
                      <button title="Salvar" className="p-2 text-slate-400 hover:text-blue-500 transition">
                        <Bookmark size={16} />
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm text-slate-600 mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Agente IA: Renda Fixa</span>
                    </div>
                    <span>há 3 horas</span>
                  </div>
                  <button className="w-full px-4 py-2 bg-pastel-blue/20 text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition">
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-pastel-green/20 overflow-hidden">
                  <img 
                    src="https://storage.googleapis.com/uxpilot-auth.appspot.com/15c1b70a0a-1efcc7f9f1aafe24a989.png" 
                    alt="illustration of payment processing systems with credit cards and digital transactions, modern fintech interface, soft pastel green tones, clean outlined illustration style with borders" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-1 bg-pastel-green/20 text-slate-700 text-xs rounded-full">Meios de Pagamento</span>
                  ...
                  <div className="flex items-center justify-between text-sm text-slate-600 mb-4">
                    <div className="flex items-center gap-2">
                      <i className="fas fa-robot"></i>
                      <span>Agente IA: Pagamentos</span>
                    </div>
                    <span>há 5 horas</span>
                  </div>
                  <button className="w-full px-4 py-2 bg-pastel-green/20 text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition">
                    Ver Análise Completa
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-pastel-purple/20 overflow-hidden">
                  <img 
                    src="https://storage.googleapis.com/uxpilot-auth.appspot.com/df884dff45-9688d032fd8d112bc1ec.png" 
                    alt="illustration of stock market trading with bull and bear symbols, financial charts and candlesticks, soft pastel purple tones, clean outlined illustration style with borders" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-1 bg-pastel-purple/20 text-slate-700 text-xs rounded-full">Renda Variável</span>
                  ...
                  <div className="flex items-center justify-between text-sm text-slate-600 mb-4">
                    <div className="flex items-center gap-2">
                      <i className="fas fa-robot"></i>
                      <span>Agente IA: Ações</span>
                    </div>
                    <span>há 1 dia</span>
                  </div>
                  <button className="w-full px-4 py-2 bg-pastel-purple/20 text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition">
                    Ver Análise Completa
                  </button>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="px-3 py-1.5 text-xs bg-slate-100 text-slate-700 rounded-lg font-medium hover:bg-slate-200 transition">
                    Ver Detalhes
                  </button>
                </div>
                <Plot
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition">
                <div className="flex gap-6">
                  <div className="w-48 h-32 bg-pastel-yellow/20 rounded-lg flex-shrink-0 overflow-hidden">
                    <img 
                      src="https://storage.googleapis.com/uxpilot-auth.appspot.com/e767b1e35f-e1497fa60b2545ea746a.png" 
                      alt="illustration of banking sector with bank building and financial services icons, modern digital banking, soft pastel yellow tones, clean outlined illustration style" 
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-1 bg-pastel-yellow/20 text-slate-700 text-xs rounded-full">Setor Bancário</span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4 text-sm text-slate-600">
                        <div className="flex items-center gap-2">
                          <i className="fas fa-robot"></i>
                          <span>Agente IA: Setor Financeiro</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Clock size={16} />
                        ...
                        <div className="flex items-center gap-2">
                          <Eye size={16} />
                          <span>842 visualizações</span>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-pastel-yellow/20 text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition text-sm">
                        Ler Mais
                      </button>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition">
                <div className="flex gap-6">
                  <div className="w-48 h-32 bg-pastel-pink/20 rounded-lg flex-shrink-0 overflow-hidden">
                    <img 
                      src="https://storage.googleapis.com/uxpilot-auth.appspot.com/ba28b58ea8-8cb1869b77ea31def56f.png" 
                      alt="illustration of real estate investment with buildings and property portfolio, financial growth charts, soft pastel pink tones, clean outlined illustration style" 
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-1 bg-pastel-pink/20 text-slate-700 text-xs rounded-full">Fundos Imobiliários</span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4 text-sm text-slate-600">
                        <div className="flex items-center gap-2">
                          <i className="fas fa-robot"></i>
                          <span>Agente IA: Imobiliário</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Clock size={16} />
                        ...
                        <div className="flex items-center gap-2">
                          <Eye size={16} />
                          <span>1.1k visualizações</span>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-pastel-pink/20 text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition text-sm">
                        Ler Mais
                      </button>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition">
                <div className="flex gap-6">
                  <div className="w-48 h-32 bg-pastel-peach/20 rounded-lg flex-shrink-0 overflow-hidden">
                    <img 
                      src="https://storage.googleapis.com/uxpilot-auth.appspot.com/ee21125d96-93cb76472c018e2b9a5f.png" 
                      alt="illustration of commodities trading with oil barrels and agricultural products, global markets, soft pastel peach tones, clean outlined illustration style" 
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-1 bg-pastel-peach/20 text-slate-700 text-xs rounded-full">Commodities</span>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4 text-sm text-slate-600">
                        <div className="flex items-center gap-2">
                          <i className="fas fa-robot"></i>
                          <span>Agente IA: Commodities</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Clock size={16} />
                        ...
                        <div className="flex items-center gap-2">
                          <Eye size={16} />
                          <span>673 visualizações</span>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-pastel-peach/20 text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition text-sm">
                        Ler Mais
                      </button>
                    </div>
                  </div>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-600 mb-4">Com a expectativa de queda na Selic, títulos prefixados longos podem oferecer ganhos interessantes de capital.</p>
                <button className="text-sm text-pastel-blue font-medium flex items-center gap-1 hover:gap-2 transition-all">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-pastel-yellow/20 rounded-lg flex items-center justify-center">
                    <i className="fas fa-exclamation-triangle text-slate-700"></i>
                  </div>
                  <span className="text-sm font-medium text-slate-700">Atenção ao Risco</span>
                </div>
                <h3 className="font-semibold text-slate-800 mb-2">Volatilidade Cambial</h3>
                <p className="text-sm text-slate-600 mb-4">O dólar pode apresentar volatilidade elevada nas próximas semanas. Considere estratégias de hedge.</p>
                <button className="text-sm text-pastel-yellow font-medium flex items-center gap-1 hover:gap-2 transition-all">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-600 mb-4">Empresas de tecnologia na B3 mostram fundamentos sólidos e perspectivas de crescimento sustentável.</p>
                <button className="text-sm text-pastel-green font-medium flex items-center gap-1 hover:gap-2 transition-all">
          ...
          {/* CTA Section */}
          <section className="mb-8">
            <div className="bg-gradient-to-r from-pastel-blue/20 to-pastel-purple/20 rounded-xl border border-slate-200 p-12">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-4">
                  <button className="px-8 py-4 bg-white text-slate-800 rounded-lg font-semibold hover:bg-slate-50 transition shadow-lg">
                    Criar Análise Personalizada
                  </button>
                  <button className="px-8 py-4 bg-slate-800 text-white rounded-lg font-semibold hover:bg-slate-700 transition">
