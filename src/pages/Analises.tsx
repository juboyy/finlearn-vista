...
const Analises = () => {
  useEffect(() => {
    document.title = "Análises de Mercado";
  }, []);
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-8">
          ...
          <section className="mb-8">
            <div className="bg-pastel-purple rounded-xl border border-slate-200 p-8">
              <div className="grid grid-cols-2 gap-8 items-center">
                ...
                <div className="h-64 bg-white rounded-xl overflow-hidden">
                  <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/7fcb40b8c2-0d96ecc5a72548820724.png" alt="Análise de mercado" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2 text-sm bg-pastel-blue text-slate-700 rounded-lg font-medium">Renda Fixa</button>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-pastel-blue overflow-hidden">
                  <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/27d7c99831-964c4d3004b99cb9421c.png" alt="Renda Fixa" className="w-full h-full object-cover" />
                </div>
                <div className="p-6">
                  ...
                  <button className="w-full px-4 py-2 bg-pastel-blue text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition">Ver Análise Completa</button>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-pastel-green overflow-hidden">
                  <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/15c1b70a0a-1efcc7f9f1aafe24a989.png" alt="Meios de Pagamento" className="w-full h-full object-cover" />
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-1 bg-pastel-green text-slate-700 text-xs rounded-full">Meios de Pagamento</span>
                  ...
                  <button className="w-full px-4 py-2 bg-pastel-green text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition">Ver Análise Completa</button>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-lg transition">
                <div className="h-48 bg-pastel-purple overflow-hidden">
                  <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/df884dff45-9688d032fd8d112bc1ec.png" alt="Renda Variável" className="w-full h-full object-cover" />
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-1 bg-pastel-purple text-slate-700 text-xs rounded-full">Renda Variável</span>
                  ...
                  <button className="w-full px-4 py-2 bg-pastel-purple text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition">Ver Análise Completa</button>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition">
                <div className="flex gap-6">
                  <div className="w-48 h-32 bg-pastel-yellow rounded-lg flex-shrink-0 overflow-hidden">
                    <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/e767b1e35f-e1497fa60b2545ea746a.png" alt="Setor Bancário" className="w-full h-full object-cover" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-1 bg-pastel-yellow text-slate-700 text-xs rounded-full">Setor Bancário</span>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="px-4 py-2 bg-pastel-yellow text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition text-sm">Ler Mais</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition">
                <div className="flex gap-6">
                  <div className="w-48 h-32 bg-pastel-pink rounded-lg flex-shrink-0 overflow-hidden">
                    <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/ba28b58ea8-8cb1869b77ea31def56f.png" alt="Fundos Imobiliários" className="w-full h-full object-cover" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-1 bg-pastel-pink text-slate-700 text-xs rounded-full">Fundos Imobiliários</span>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="px-4 py-2 bg-pastel-pink text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition text-sm">Ler Mais</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition">
                <div className="flex gap-6">
                  <div className="w-48 h-32 bg-pastel-peach rounded-lg flex-shrink-0 overflow-hidden">
                    <img src="https://storage.googleapis.com/uxpilot-auth.appspot.com/ee21125d96-93cb76472c018e2b9a5f.png" alt="Commodities" className="w-full h-full object-cover" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-1 bg-pastel-peach text-slate-700 text-xs rounded-full">Commodities</span>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="px-4 py-2 bg-pastel-peach text-slate-700 rounded-lg font-medium hover:bg-opacity-80 transition text-sm">Ler Mais</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-600 mb-4">Com a expectativa de queda na Selic, títulos prefixados de longo prazo podem oferecer retornos atrativos nos próximos meses.</p>
                <button className="text-sm text-pastel-blue hover:underline font-medium">Ver Análise Completa →</button>
              </div>
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-sm text-slate-600 mb-4">Cenário internacional incerto pode gerar volatilidade no câmbio. Considere estratégias de hedge para exposições em dólar.</p>
                <button className="text-sm text-pastel-yellow hover:underline font-medium">Ver Análise Completa →</button>
              </div>
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm font-medium text-slate-700">Tendência</span>
                </div>
                <h3 className="font-semibold text-slate-800 mb-2">Crescimento do Pix</h3>
                <p className="text-sm text-slate-600 mb-4">O Pix continua crescendo e transformando o setor de pagamentos. Empresas do setor podem se beneficiar dessa tendência.</p>
                <button className="text-sm text-pastel-green hover:underline font-medium">Ver Análise Completa →</button>
              </div>
            </div>
          </section>
