            ...
            <div className="bg-card rounded-2xl shadow-2xl w-full max-w-4xl relative border border-border animate-fade-in overflow-hidden flex flex-col max-h-[90vh]">
              ...
              <div className="p-6 overflow-y-auto">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Option 9: Newspaper */}
                  <Link to="/nova-newsletter" className="w-full group flex items-center gap-4 p-3 rounded-xl hover:bg-muted/50 transition-all duration-200 border border-transparent hover:border-border text-left">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">Crie newsletters e curadoria de conteúdo.</p>
                    </div>
                    <div className="text-muted-foreground/30 group-hover:text-muted-foreground transition-colors">
                      <i className="fa-solid fa-chevron-right text-sm"></i>
                    </div>
