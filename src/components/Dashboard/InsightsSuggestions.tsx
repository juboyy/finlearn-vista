...
const mockInsights = [
  ...
  },
  {
    ...
    priority: "high" as const,
    is_read: false,
    metadata: { showAuthor: true, authorName: "Marina Costa", articleTitle: "Protocolos DeFi no Brasil", link: "/artigo" },
