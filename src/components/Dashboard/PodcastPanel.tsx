...
export function PodcastPanel({ open, onOpenChange }: PodcastPanelProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-[90vw] sm:w-[780px] max-w-[780px] overflow-y-auto overflow-x-hidden bg-gradient-to-br from-background via-background to-muted/30 backdrop-blur-xl border-l-2 border-pastel-purple/20">
