    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-[600px] sm:max-w-[600px] overflow-y-auto">
        ...
        <div className="py-6 space-y-4">
          {/* Insight Principal */}
          <div className="bg-gradient-to-br from-pastel-purple/20 to-pastel-pink/20 rounded-xl border-2 border-pastel-purple p-5">
          ...
          {/* Matéria em Alta */}
          <div className="bg-white rounded-xl border-2 border-pastel-blue p-4 hover:shadow-lg transition-shadow cursor-pointer">
            <div className="flex items-start gap-4">
          ...
          <div className="bg-white rounded-xl border-2 border-pastel-green p-4 hover:shadow-lg transition-shadow cursor-pointer">
            <div className="flex items-start gap-4">
          ...
          {/* Lembrete de Curso */}
          <div className="bg-white rounded-xl border-2 border-pastel-peach p-4 hover:shadow-lg transition-shadow cursor-pointer">
            <div className="flex items-start gap-4">
          ...
          {/* Tema Sugerido */}
          <div className="bg-white rounded-xl border-2 border-pastel-yellow/70 p-4 hover:shadow-lg transition-shadow cursor-pointer">
            <div className="flex items-start gap-4">
          ...
          {/* Resultado de Post */}
          <div className="bg-gradient-to-br from-pastel-pink/20 to-pastel-peach/20 rounded-xl border-2 border-pastel-pink p-4">
            <div className="flex items-start gap-4">
          ...
          {/* Evento Próximo */}
          <div className="bg-white rounded-xl border border-border p-4 hover:shadow-lg transition-shadow cursor-pointer">
            <div className="flex items-start gap-4">
          ...
          {/* Conquista */}
          <div className="bg-gradient-to-br from-pastel-green/20 to-pastel-blue/20 rounded-xl border-2 border-pastel-green p-4">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-pastel-green rounded-lg flex items-center justify-center flex-shrink-0">
