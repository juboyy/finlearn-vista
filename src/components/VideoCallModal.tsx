            ...
            <div className="bg-slate-900 border-2 border-slate-700 rounded-2xl shadow-2xl w-full max-w-[95vw] max-h-[85vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
              ...
              <div className="p-6 border-t border-slate-800 bg-slate-900/50">
                <div className="flex gap-3">
                  <Button className="flex-1 bg-pastel-blue hover:bg-pastel-blue/80 text-slate-900">
                    Exportar Relatório
                  </Button>
                  <Button variant="outline" className="flex-1 border-slate-600 text-slate-600 hover:bg-slate-600 hover:text-white hover:border-white transition-all" onClick={() => setShowStatsModal(false)}>
                    Fechar
                   </Button>
                </div>
              </div>
